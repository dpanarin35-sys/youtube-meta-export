...
4. `oauth-consent.png` — Google OAuth consent screen, scope request, and the app's consent checkbox.
5. `export-caption-option.png` — selected videos and the unchecked "Include caption text" option.
6. `revoke-access.png` — signed-in view with the "Revoke access and delete data" action.
7. `architecture.svg` — technical data-flow diagram included in this directory.
